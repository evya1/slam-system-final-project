...
public:
    ...
    // Build a lookup: for each map point, return a list of {map_point_index}
    // for every observation in the given frame.
    // Key: keypoint_idx in that frame → map_point index in map_points_
